...
const Footer = () => {
  return (
    <footer className="px-20 py-8 bg-gray-100">
      <div className="container mx-auto">
        <div className="border-b border-gray-300 pb-6 mb-6">
          <h2 className="text-lg font-semibold mb-4">Inspiration for future getaways</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8"><div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-8 text-sm text-gray-500">
          ...
          <div className="flex items-center space-x-4 mt-4 sm:mt-0">
            ...
            <div className="flex space-x-3">
              <a href="#" className="flex h-6 aspect-square items-center justify-center text-xl bg-zinc-800 "><i className="ri-facebook-fill text-zinc-100"></i></a>
              <a href="#" className="flex h-6 aspect-square items-center justify-center text-xl bg-zinc-800 "><i className="ri-twitter-fill text-zinc-100"></i></a>
              <a href="#" className="flex h-6 aspect-square items-center justify-center text-xl bg-zinc-800 "><i className="ri-instagram-line text-zinc-100"></i></a>
            </div>
          </div>
        </div>
      </div>
